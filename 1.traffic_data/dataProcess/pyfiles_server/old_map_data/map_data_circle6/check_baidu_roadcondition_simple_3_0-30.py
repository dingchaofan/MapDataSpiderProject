...
import math
import h5py
import matplotlib.image as mpimg # mpimg Ã§Â”Â¨Ã¤ÂºÂŽÃ¨Â¯Â»Ã¥ÂÂ–Ã¥Â›Â¾Ã§Â‰Â‡
import random
import time
...
def real_coordinate(lat_deg,lon_deg,level):#Ã¦ Â¹Ã¦ÂÂ®Ã§Â»ÂÃ§ÂºÂ¬Ã¥ÂºÂ¦Ã¨Â®Â¡Ã§Â®Â—Ã¥Â›Â¾Ã§Â‰Â‡Ã¥ÂÂÃ¦ Â‡Ã§ÂšÂ„Ã¥Â‡Â½Ã¦Â•Â°
...
def down_a_map(time_now):   
    ...
    size = 256
    # level 14 in most part of circle6
    start_x = 3170
    start_y = 1186
    level = 14
    x_range = 14
...
#è½¬æ¢æˆæ–°çš„æ—¶é—´æ ¼å¼?2016-05-09 18:59:20)
dt = time.strftime("%Y-%m-%d %H:%M:%S",time_local)

print dt

#è½¬æ¢æˆæ—¶é—´æ•°ç»?timeArray = time.strptime(dt, "%Y-%m-%d %H:%M:%S")
#è½¬æ¢æˆæ—¶é—´æˆ³
...
#%%
#Ã¤ÂºÂ”Ã¥ÂˆÂ†Ã©Â’ÂŸÃ¤Â¸Â€Ã¦Â¬Â¡Ã¯Â¼ÂŒÃ¦ÂÂÃ¥ÂÂ–Ã¥ÂŒÂ—Ã¤ÂºÂ¬Ã¥Â¸Â‚Ã¥ÂŒÂºÃ§ÂšÂ„Ã¨Â·Â¯Ã¥Â†ÂµÃ¥Â›Â¾Ã¯Â¼ÂŒÃ¤Â»ÂŽ20170101 00:00:00 Ã¥Â¼Â€Ã¥Â§?

#ss = time_input/1000.0
#localtime = time.localtime( time.time() )
#print "Ã¦ÂœÂ¬Ã¥ÂœÂ°Ã¦Â—Â¶Ã©Â—Â´Ã¤Â¸?:", localtime
...
#     print "file exists"
# else:
#     #ä¸‹è½½å›¾ç‰‡ æŒ‰ç…§æ—¶é—´æˆ?#     ss = down_a_map(timestamp)  
